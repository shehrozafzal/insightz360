...
<!-- Mirrored from themepure.net/template/techbuzz-prv/techbuzz/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Feb 2022 19:54:23 GMT -->
<head>
...
<body>
   <!--[if lt IE 8]>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-8 col-sm-8">
                        <div class="header__top--info header__top--info--2">
                            <ul>
                                <li><a href="https://themepure.net/cdn-cgi/l/email-protection#99f0f7fff6d9eefcfbf4f8f0f5b7faf6f4"><span class="__cf_email__" data-cfemail="2940474f46695e4c4b44484045074a4644">[email&#160;protected]</span></a></li>
                                <li><a href="tel:9878768648765">+987 876 86 48 765</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="header__top--info--right header__top--info--right--2">
                            <div class="lang">
                                <div class="lang__icon">
                                    <a href="#0" class="lang__btn lang__btn--2">English <i class="fal fa-angle-down"></i></a>
                                    <ul class="lang__list">
    ...
    <!-- banner area start -->
    <section class="banner__area banner__area--2 pt-135 pb-135 bg_img" data-background="assets/images/banner/banner-bg-2.jpg">
                ...
                <div class="row">
                    <div class="col-xl-5 offset-xl-6 col-lg-6 offset-lg-6 col-md-7 offset-md-5 col-sm-7 offset-sm-5">
                        <div class="bannertext bannertext__2">
                            <a href="http://www.youtube.com/embed/4xe72U7mXNg?rel=0&amp;controls=0&amp;showinfo=0" data-rel="lightcase:myCollection"
    ...
    <!-- about area start -->
    <section class="about__area about__area--2 grey-bg bg_img pt-95 pb-100" data-background="assets/images/bg/about-bg-2.png">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row mt-none-30">
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <div class="process__box">
                        <div class="process__box--thumb">
                            <img src="assets/images/service/process-1.jpg" alt="">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <div class="process__box">
                        <div class="process__box--thumb">
                            <img src="assets/images/service/process-2.jpg" alt="">
                            <a href="service-details.html" class="site-btn transparent white">Learn More <span>+</span></a>
                        </div>
                        <div class="process__box--content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <div class="process__box">
                        <div class="process__box--thumb">
                            <img src="assets/images/service/process-3.jpg" alt="">
                            <a href="service-details.html" class="site-btn transparent white">Learn More <span>+</span></a>
                        </div>
                        <div class="process__box--content">
                ...
                <div class="col-xl-6 align-self-center">
                    <div class="faq__thumb text-center">
                        <div class="faq__thumb--big" data-tilt data-tilt-perspective="3000">
                            <img src="assets/images/others/faq-thumb-big.jpg" alt="">
                        </div>
                        <div class="faq__thumb--1" data-tilt data-tilt-perspective="3000">
                            <img src="assets/images/others/faq-thumb-1.jpg" alt="">
                        </div>
                        <div class="faq__thumb--2" data-tilt data-tilt-perspective="3000">
                            <img src="assets/images/others/faq-thumb-2.jpg" alt="">
                        </div>
                        <div class="faq__thumb--3" data-tilt data-tilt-perspective="3000">
                            <img src="assets/images/others/faq-thumb-3.jpg" alt="">
                        </div>
                        <div class="faq__thumb--4" data-tilt data-tilt-perspective="3000">
                            <img src="assets/images/others/faq-thumb-4.jpg" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-none-30">
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <article class="blog__box">
                        <div class="thumb">
                            <img src="assets/images/news/news-standard-1.jpg" alt="">
                        </div>
                        <div class="content">
                            ...
                            <div class="meta">
                                <div class="authore">
                                    <div class="authore__thumb">
                                        <img src="assets/images/news/news-authore-1.png" alt="">
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <article class="blog__box">
                        <div class="thumb">
                            <img src="assets/images/news/news-standard-2.jpg" alt="">
                        </div>
                        <div class="content">
                            <span class="cat">// it solutions</span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 mt-30">
                    <article class="blog__box">
                        <div class="thumb">
                            <img src="assets/images/news/news-standard-3.jpg" alt="">
                        </div>
                        <div class="content">
                            <span class="cat">// it solutions</span>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 offset-xl-1">
                    <div class="newslater__form">
                        <form action="https://themepure.net/template/techbuzz-prv/techbuzz/index.html">
    ...
    <!-- footer area start -->
    <footer class="site__footer site__footer--2 pt-90">
        <div class="container">
            <div class="row mt-none-30">
                <div class="col-xl-4 col-lg-6 col-md-5 mt-30">
                    <div class="footer__widget footer__widget--2">
                        ...
                        <div class="contact-info">
                            <ul>
                                <li><a href="https://themepure.net/cdn-cgi/l/email-protection#60090e060f201705020d01090c4e030f0d"><i class="fal fa-envelope"></i> <span class="__cf_email__" data-cfemail="80e9eee6efc0f7e5e2ede1e9ecaee3efed">[email&#160;protected]</span></a></li>
                                <li><a href="tel:+987876765654554"><i class="fal fa-phone"></i> +987 876 765 654 554</a></li>
                                <li><i class="fal fa-map-marker-alt"></i> 13/A, Holownin City, NYC</li>
                            </ul>
                        </div>
                        <a href="contact.html" class="site-btn mt-40">Get Direction <span><i class="fal fa-arrow-right"></i></span></a>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 mt-30">
                    <div class="footer__widget footer__widget--2">
                        ...
                        <div class="newsfeed__wrap">
                            <div class="newsfeed__item newsfeed__item--2 mb-20">
                                <div class="thumb">
                                    <img src="assets/images/news/news-small-3.jpg" alt="">
                                </div>
                                <div class="content">
                                    <ul class="meta">
                            ...
                            <div class="newsfeed__item newsfeed__item--2">
                                <div class="thumb">
                                    <img src="assets/images/news/news-small-4.jpg" alt="">
                                </div>
                                <div class="content">
                                    <ul class="meta">
                                        <li><a href="#0"><i class="fal fa-calendar-alt"></i> 24th June 2020</a></li>
        ...
        <div class="copyright__area mt-80">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="copyright-text">
                            <div class="row">
                                <div class="col-xl-12 text-center">
                                    <p>Copyright <a href="https://themepure.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="76340f36330e171b061a13">[email&#160;protected]</a> - <span>2020</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themepure.net/template/techbuzz-prv/techbuzz/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Feb 2022 19:54:50 GMT -->
</html>