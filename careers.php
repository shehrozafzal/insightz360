...
<head>
    ...
    <!--====== Title ======-->
    <title>Careers - Insights360</title>
                    ...
                    <div class="career__bg">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 mt-30">
                                <img src="assets/images/bg/careers-bg-1.jpg" alt="">
                            </div>
                            <div class="col-xl-6 col-lg-6 mt-30">
                                <img src="assets/images/bg/careers-bg-2.jpg" alt="">
                            </div>
                        </div>
                        <a href="index.html" class="site-btn">Insights360.</a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10 mt-30">
                    <img src="assets/images/bg/careers-bg-3.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row mb-60">
                <div class="col-xl-6 col-lg-6 col-md-7">
                    <div class="section__heading">
                        <h4 class="section__heading--title-small"><span class="mr-10"><i class="fal fa-hand-o-right"></i></span> Other benifits</h4>
            ...
            <div class="row custom-row mt-none-30">
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mt-30">
                    <div class="support__box support__box--2">
                        <div class="icon">
                            <img src="assets/images/icons/support-icon-h-6.png" class="default" alt="">
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mt-30">
                    <div class="support__box support__box--2">
                        <div class="icon">
                            <img src="assets/images/icons/support-icon-h-7.png" class="default" alt="">
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mt-30">
                    <div class="support__box support__box--2">
                        <div class="icon">
                            <img src="assets/images/icons/support-icon-h-8.png" class="default" alt="">
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mt-30">
                    <div class="support__box support__box--2">
                        <div class="icon">
                            <img src="assets/images/icons/support-icon-h-9.png" class="default" alt="">
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mt-30">
                    <div class="support__box support__box--2">
                        <div class="icon">
                            <img src="assets/images/icons/support-icon-h-10.png" class="default" alt="">
